...
RUN wget https://github.com/apache/qpid-proton/archive/0.22.0-rc1.tar.gz
RUN tar -xf 0.22.0-rc1.tar.gz
RUN mv qpid-proton-0.22.0-rc1/ qpid-proton-0.22.0/
RUN tar -z -cf qpid-proton-0.22.0.tar.gz qpid-proton-0.22.0/
RUN rm -rf 0.22.0-rc1.tar.gz qpid-proton-0.22.0/
