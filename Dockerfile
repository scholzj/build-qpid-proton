...
RUN wget https://github.com/apache/qpid-proton/archive/0.19.0.tar.gz
RUN tar -xf 0.19.0.tar.gz
RUN tar -z -cf qpid-proton-0.19.0.tar.gz qpid-proton-0.19.0/
RUN rm -rf 0.19.0.tar.gz qpid-proton-0.19.0/
