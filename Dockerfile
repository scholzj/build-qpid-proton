...
# RUN mv qpid-proton-master/ qpid-proton-0.15.0/
# RUN tar -z -cf qpid-proton-0.15.0.tar.gz qpid-proton-0.15.0/
# RUN rm -rf master.tar.gz qpid-proton-0.15.0/
...
RUN curl -v -u $FTP_USERNAME:$FTP_PASSWORD ftp://$FTP_HOSTNAME/FileTodelete.xml -Q 'DELETE FileTodelete.xml'
