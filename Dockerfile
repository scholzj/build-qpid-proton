...
RUN wget https://github.com/apache/qpid-proton/archive/0.14.0-rc.tar.gz
RUN tar -xf 0.14.0-rc.tar.gz
RUN mv qpid-proton-0.14.0-rc qpid-proton-0.14.0
RUN tar -z -cf qpid-proton-0.14.0.tar.gz qpid-proton-0.14.0/
RUN rm -rf 0.14.0-rc.tar.gz qpid-proton-0.14.0
